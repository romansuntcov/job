	...
	<div class="elem">
		...
		<div class="redaction">
			<?php
			   ...
			   if($k == $row['id_project']){
				  echo "<div class=\"elem\">";
			    echo "<form action=\"edit_project.php\" method=\"post\"><p>Название проекта</p>  
      		...
      		echo "<form action=\"upload.php\" method=\"post\" enctype=\"multipart/form-data\">
				    	  <p>Обновить превью-картинку</p><br> 
						    <textarea style=\"display:none;\" name=\"main_img\">".($row['main_img'])."</textarea> 
              ...
              <input type=\"file\" name=\"filename\"><br> 
      				<input type=\"submit\" value=\"Загрузить\"><br>
      				<input type=\"hidden\" name=\"ind\" value=\"2\">
      				<input type=\"hidden\" name=\"k\" value=\"".$k."\">
      				</form> ";
  				}
  			}
