	...
	<div id="admin">
		<div class="login" >
			...
			<form action="admin/authorize.php" method="post">
     		<input type="text" name="user_name" value="Введите имя"onfocus="if (this.value == 'Введите имя') {this.value=''}" 
			onblur="if (this.value == '') {this.value='Введите имя'}"/>
    		<input type="text" name="user_pass" value="Введите пароль" onfocus="if (this.value == 'Введите пароль') {this.value=''}" 
			onblur="if (this.value == '') {this.value='Введите пароль'}"/>
