...
<head>
	...
	<META NAME="keywords" CONTENT="brandinspire, brand inspire, branding for designers, logo for interior designers, PR for interior designers, go to market stategy Russian market, web design for interior designers, marketing services for interior designers, marketing agency in Russia, social media agency in Russia, how to entry russian market">
    <META NAME="description" CONTENT="Brand Inspire is an integrated creative agency for creative industries - design-oriented companies, furniture and home lifestyle products brands. ">
        ...
        function AjaxFormRequest(result_id,formMain,url) {
            jQuery.ajax({
                ...
                error: function(response) {
                    document.getElementById(result_id).innerHTML = "Error. Please try again";
                }
            });
        }
</script>
