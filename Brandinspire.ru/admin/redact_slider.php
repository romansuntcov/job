<div class="admin_main">
	<div class="elem">
		...
		<div class="admin_title">
			Изменение подписивнутри слайда.<br>
			...
			<?php
				...
				while($row = mysql_fetch_array($result)){
					if($k == $row['id_slide']){
				    	...
				    	echo "<form action=\"upload.php\" method=\"post\" enctype=\"multipart/form-data\"><p>Обновить слайд</p><br> <textarea style=\"display:none;\" name=\"content\">".($row['image'])."</textarea><input type=\"file\" name=\"filename\"><br> <input type=\"submit\" value=\"Обновить картинку слайдера\"><br><input type=\"hidden\" name=\"k\" value=\"".$k."\"></form> ";	
  					}
  				}
			?>
		</div>
