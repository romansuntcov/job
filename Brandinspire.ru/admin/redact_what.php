<div class="admin_main">
	<div class="elem">
		...
		<div class="admin_title">
			...
			Изменение заголовка и текста внутри выплывающего окна.<br>
			Изменение списков внутри выплывающего окна(заголовков и пунктов).
		</div>
		<div class="redaction">
			<?php
				...
				while($row = mysql_fetch_array($result)){
					if($k == $row['id_what']){
						...
						<p>Подпись элемента на главной странице</p>  
     					...
     					<p>Заголовок левой колонки внутри выплывающего окна</p> 
     					<textarea name=\"full_title\">".($row['full_title'])."</textarea>
     					<p>Текст левой колонки внутри выплывающего окна</p> 
