		...
		<div class="redaction">
			<?php
				...
				while($row_2 = mysql_fetch_array($result_2)){
					if($k == $row_2['id_point']){
					    echo "<div class=\"elem\">";
						echo "<form action=\"edit_branding.php\" method=\"post\"><p>Заголовок списка</p>  <textarea name=\"elem_name\">".($row_2['title'])."</textarea> <p>Cписок</p> <textarea name=\"text\">".($row_2['points'])."</textarea><input type=\"hidden\" name=\"id_2\" value=\"".$row_2['id_point']."\"><input type=\"hidden\" name=\"k\" value=\"".$k."\">";
